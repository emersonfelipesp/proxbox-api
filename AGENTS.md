...
3. **Data-only request** — `.gitea/workflows/publish-gitea.yml` builds wheel, sdist, manifest, and canonical `release-request.json`; it has no package or mirror credential and cannot publish or push tags.
