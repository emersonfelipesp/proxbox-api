...
Current pairing: `netbox-proxbox 0.0.26.post1 ... proxbox-api 0.0.21.post5 ... proxmox-sdk 0.0.13 ... netbox-sdk 0.0.13`.
`proxbox-api 0.0.21.post5` adds authenticated Proxmox console WebSocket handshakes,
typed-sidecar-only inventory state, NetBox 4.6.6 certification, strict Python
3.12/3.13 support, a verified network-free production release context, and an
isolated two-artifact manifest used by package-first production deployments.
