...
from proxbox_api.routes.proxmox.viewer_codegen import common_router as viewer_codegen_common_router

router.include_router(viewer_codegen_common_router, prefix="/viewer", tags=["proxmox / viewer"])
