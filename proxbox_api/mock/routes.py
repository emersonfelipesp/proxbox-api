...
from proxbox_api.mock.schema_helpers import (
...
from proxbox_api.mock.state import shared_mock_store
...
def _load_model_module(openapi_document: dict[str, object], version_tag: str) -> ModuleType:
    ...
    module = ModuleType(f"proxbox_api.mock.generated_{version_tag.replace('.', '_')}")
