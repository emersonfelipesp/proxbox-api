...
class GetClusterAcmePluginsIdResponse(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class DeleteClusterHaResourcesSidRequest(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class PostClusterHaResourcesSidMigrateResponse(RootModel[None]):
    root: None = Field(...)

class PostClusterHaResourcesSidRelocateRequest(ProxmoxBaseModel):
    node: str = Field(..., description='Target node.')

class PostClusterHaResourcesSidRelocateResponse(RootModel[None]):
    root: None = Field(...)
...
class GetClusterReplicationResponse(RootModel[list[dict[str, object]]]):
    root: list[dict[str, object]] = Field(...)
...
class GetClusterReplicationIdResponse(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class GetClusterResourcesResponseItem(ProxmoxBaseModel):
    ...
    diskread: int | None = Field(None, description="The amount of bytes the guest read from its block devices since the guest was started. This info is not available for all storage types. (for types 'qemu' and 'lxc')")
    diskwrite: int | None = Field(None, description="The amount of bytes the guest wrote to its block devices since the guest was started. This info is not available for all storage types. (for types 'qemu' and 'lxc')")
...
class GetClusterSdnControllersResponseItem(ProxmoxBaseModel):
    controller: str | None = Field(None)
    pending: bool | None = Field(None)
...
class DeleteClusterSdnControllersControllerRequest(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)

class DeleteClusterSdnControllersControllerResponse(RootModel[None]):
    root: None = Field(...)

class GetClusterSdnControllersControllerResponse(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class DeleteClusterSdnDnsDnsRequest(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class DeleteClusterSdnIpamsIpamRequest(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class GetClusterSdnVnetsResponse(RootModel[list[dict[str, object]]]):
    root: list[dict[str, object]] = Field(...)
...
class DeleteClusterSdnVnetsVnetRequest(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)

class DeleteClusterSdnVnetsVnetResponse(RootModel[None]):
    root: None = Field(...)

class GetClusterSdnVnetsVnetResponse(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class DeleteClusterSdnVnetsVnetSubnetsSubnetRequest(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class GetClusterSdnZonesResponseItem(ProxmoxBaseModel):
    dhcp: str | None = Field(None)
    dns: str | None = Field(None)
    dnszone: str | None = Field(None)
    ipam: str | None = Field(None)
    mtu: int | None = Field(None)
    nodes: str | None = Field(None)
    pending: bool | None = Field(None)
    reversedns: str | None = Field(None)
    state: str | None = Field(None)
    type: str | None = Field(None)
...
class DeleteClusterSdnZonesZoneRequest(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)

class DeleteClusterSdnZonesZoneResponse(RootModel[None]):
    root: None = Field(...)

class GetClusterSdnZonesZoneResponse(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class GetNodesNodeAptUpdateResponse(RootModel[list[dict[str, object]]]):
    root: list[dict[str, object]] = Field(...)
...
class GetNodesNodeAptVersionsResponse(RootModel[list[dict[str, object]]]):
    root: list[dict[str, object]] = Field(...)
...
class GetNodesNodeCephMdsResponseItem(ProxmoxBaseModel):
    ...
    name: object | None = Field(None, description='The name (ID) for the MDS')
...
class GetNodesNodeCephMgrResponseItem(ProxmoxBaseModel):
    addr: str | None = Field(None)
    host: str | None = Field(None)
    name: object | None = Field(None, description='The name (ID) for the MGR')
...
class GetNodesNodeNetworkResponse(RootModel[list[dict[str, object]]]):
    root: list[dict[str, object]] = Field(...)
...
class PostNodesNodeQemuVmidAgentExecRequest(ProxmoxBaseModel):
    command: list[object] = Field(..., description='The command as a list of program + arguments.')
...
class GetNodesNodeQemuVmidMigrateResponse(ProxmoxBaseModel):
    allowed_nodes: list[object] | None = Field(None, description='List nodes allowed for offline migration, only passed if VM is offline')
    local_disks: list[object] = Field(..., description='List local disks including CD-Rom, unused and not referenced disks')
    local_resources: list[object] = Field(..., description='List local resources e.g. pci, usb')
    mapped_resources: list[object] = Field(..., alias="mapped-resources", description='List of mapped resources e.g. pci, usb')
    not_allowed_nodes: dict[str, object] | None = Field(None, description='List not allowed nodes with additional information, only passed if VM is offline')
    running: bool = Field(...)
...
class GetNodesNodeScanGlusterfsResponseItem(ProxmoxBaseModel):
    volname: str | None = Field(None, description='The volume name.')

class GetNodesNodeScanGlusterfsResponse(RootModel[list[GetNodesNodeScanGlusterfsResponseItem]]):
    root: list[GetNodesNodeScanGlusterfsResponseItem] = Field(...)
...
class GetNodesNodeServicesResponse(RootModel[list[dict[str, object]]]):
    root: list[dict[str, object]] = Field(...)
...
class GetNodesNodeServicesServiceStateResponse(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class GetNodesNodeStorageStorageStatusResponse(RootModel[dict[str, object]]):
    root: dict[str, object] = Field(...)
...
class PostStorageResponse(ProxmoxBaseModel):
    config: dict[str, object] | None = Field(None, description='Partial, possible server generated, configuration properties.')
