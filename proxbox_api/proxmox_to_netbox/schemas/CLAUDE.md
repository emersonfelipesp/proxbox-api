...
This file lives at `/root/personal-context/nmulticloud-context/proxbox-api/proxbox_api/proxmox_to_netbox/schemas/CLAUDE.md` inside the `personal-context` workspace.
