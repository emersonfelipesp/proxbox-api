...
def _int_or(value: object, default: int) -> int:
    """Coerce an integer setting, treating unparseable, missing, and zero as ``default``."""
    return _coerce_int(value, default=default) or default


def _int_allow_zero(value: object, default: int) -> int:
    """Coerce an integer setting, treating only unparseable or missing input as ``default``."""
...
def _normalize_settings_payload(settings: dict[str, Any]) -> ProxboxSettingsDict:
    ...
    return {
        ...
        "netbox_timeout": _int_or(settings.get("netbox_timeout"), 120),
        "netbox_max_concurrent": _int_or(settings.get("netbox_max_concurrent"), 1),
        "netbox_max_retries": _int_allow_zero(settings.get("netbox_max_retries"), 5),
        "netbox_retry_delay": _coerce_finite_float(settings.get("netbox_retry_delay"), default=2.0),
        "netbox_get_cache_ttl": _coerce_finite_float(
            settings.get("netbox_get_cache_ttl"), default=60.0
        ),
        "netbox_get_cache_max_entries": _int_or(settings.get("netbox_get_cache_max_entries"), 4096),
        "netbox_get_cache_max_bytes": _int_or(
        ...
        "ensure_netbox_objects": _coerce_bool(settings.get("ensure_netbox_objects"), default=True),
        ...
        "proxmox_timeout": _int_or(settings.get("proxmox_timeout"), 5),
        "proxmox_max_retries": _int_or(settings.get("proxmox_max_retries"), 0),
        ...
        "ceph_task_timeout": _coerce_finite_float(settings.get("ceph_task_timeout"), default=300.0),
